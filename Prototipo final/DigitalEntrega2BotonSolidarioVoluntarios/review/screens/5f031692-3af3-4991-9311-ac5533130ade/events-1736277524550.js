jQuery("#simulation")
  .on("click", ".s-5f031692-3af3-4991-9311-ac5533130ade .click", function(event, data) {
  ...
  .on("mouseenter dragenter", ".s-5f031692-3af3-4991-9311-ac5533130ade .mouseenter", function(event, data) {
    var jEvent, jFirer, cases;
    if(jimUtil.isAlternateModeActive()) return;
    if(data === undefined) { data = event; }
    jEvent = jimEvent(event);
              ...
              "actions": [
                {
                  ...
                  "parameter": [ {
                    "target": [ "#s-5f031692-3af3-4991-9311-ac5533130ade #s-Button_1 > .backgroundLayer > .colorLayer" ],
                    "attributes": {
              ...
              "actions": [
                {
                  "action": "jimChangeStyle",
                  "parameter": [ {
                    "target": [ "#s-5f031692-3af3-4991-9311-ac5533130ade #s-Text_1 span" ],
                    "attributes": {
                      "color": "#000000"
                    }
                  } ],
              ...
              "actions": [
                {
                  "action": "jimChangeStyle",
                  "parameter": [ {
                    "target": [ "#s-5f031692-3af3-4991-9311-ac5533130ade #s-Text_2 span" ],
                    "attributes": {
                      "color": "#000000"
                    }
                  } ],
              ...
              "actions": [
                {
                  "action": "jimChangeStyle",
                  "parameter": [ {
                    "target": [ "#s-5f031692-3af3-4991-9311-ac5533130ade #s-Text_3 span" ],
                    "attributes": {
                      "color": "#000000"
                    }
                  } ],
              ...
              "actions": [
                {
                  "action": "jimChangeStyle",
                  "parameter": [ {
                    "target": [ "#s-5f031692-3af3-4991-9311-ac5533130ade #s-Text_4 span" ],
                    "attributes": {
                      "color": "#000000"
                    }
                  } ],
  ...
  .on("mouseleave dragleave", ".s-5f031692-3af3-4991-9311-ac5533130ade .mouseleave", function(event, data) {
    var jEvent, jFirer, cases;
    if(jimUtil.isAlternateModeActive()) return;
    if(data === undefined) { data = event; }
    jEvent = jimEvent(event);
